...
fout=/home/linaiqi/Lab/data/gene/tmp/result\_pidc\_100gene.txt
rm -f $fout
...
do
    ...
    do
        echo -n "pidc net $i sizen $sizen " >> $fout
        gsfile=/home/linaiqi/Lab/data/gene/gene100net$i.xml
        predfile=/home/linaiqi/Lab/data/gene/tmp/pidc_mf100net$i\_n$sizen.txt
