...
fout=/home/linaiqi/Lab/data/gene/tmp/result\_grnboost2\_100gene.txt
rm -f $fout
...
do
    ...
    do
        echo -n "grnboost2 net $i sizen $sizen " >> $fout
        gsfile=/home/linaiqi/Lab/data/gene/gene100net$i.xml
        predfile=/home/linaiqi/Lab/data/gene/tmp/grnboost2_mf100net$i\_n$sizen.txt
